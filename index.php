		...
		<div class="presentation-grid">
			<div class="presentation-text">
				<div class="presentation-text-flex" data-aos="fade-right" data-aos-duration="2000">
					<p>Você Virtual</p>
					<h2>O melhor do Home Office!</h2>
					<p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quod repellat impedit officia placeat quibusdam qui, exercitationem cupiditate sequi praesentium, voluptatem perferendis asperiores minus, vero quos numquam fugiat necessitatibus eveniet adipisci.</p>
